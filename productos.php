...
// Obtener todos los productos (esto puedes ajustar después con la lógica real)
...
<head>
    <meta charset="UTF-8">
    <title>Gestión Productos - AgroConecta</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item"><a class="nav-link active" href="productos.php">Gestión Productos</a></li>
      </ul>
